...
def registerUser(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            user.save()
            login(request, user) # sending them after login in to home page
            return redirect('home')
        else:
...
def home(request):
    ...
    room_messages=Message.objects.filter(Q(room__topic__name__icontains=q)) #I can only see the topic srelated to  particular topic
